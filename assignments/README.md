...
本集训基于 Stanford CS336。A1 已正式发布；A2-P 与 A2-K 为发布候选稿，在状态改为
...
| [A2-K](A2-K/README.md) | 单卡显存优化与 GPU Kernels（A2 子作业） | 发布候选，请勿提交 | [实验室候选题面](A2-K/README.md) · [Stanford A2 固定快照](https://github.com/stanford-cs336/assignment2-systems/tree/ca8bc81a59b70516f7ebb2da4808daade877c736) |
...
A2-K 候选题面复用同一个固定兄弟仓库，但只同步 `cs336_systems/a2k/**/*.py`、
