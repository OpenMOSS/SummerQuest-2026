...
`profiling/**/*.py`。完整要求见 [A2-P 候选题面](assignments/A2-P/README.md)。

A2-K 与 A2-P 共用同一个固定 commit 的兄弟仓库，但使用独立目录、同步脚本和 PR。A2-K
候选稿只同步学生自己编写的 `cs336_systems/a2k/**/*.py`、`tests/adapters.py` 与
...
[A2-K 候选题面](assignments/A2-K/README.md)。
...
| [A2-P](assignments/A2-P/README.md) | Profiling 与性能分析（A2 子作业） | 发布候选，请勿提交 | [实验室候选题面](assignments/A2-P/README.md) · [Stanford A2 固定快照](https://github.com/stanford-cs336/assignment2-systems/tree/ca8bc81a59b70516f7ebb2da4808daade877c736) |
| [A2-K](assignments/A2-K/README.md) | 单卡显存优化与 GPU Kernels（A2 子作业） | 发布候选，请勿提交 | [实验室候选题面](assignments/A2-K/README.md) · [Stanford A2 固定快照](https://github.com/stanford-cs336/assignment2-systems/tree/ca8bc81a59b70516f7ebb2da4808daade877c736) |
...
A2-P 与 A2-K 已形成发布候选稿，在状态改为“已发布”前请勿提交；A3-A5 的链接只用于
提前了解原版内容。已发布作业的提交目录、文件格式和 PR 要求以本仓库对应题面为准。
