...
_LOCAL_PACKAGE = Path(__file__).resolve().parents[1] / "cs336_systems"
if str(_LOCAL_PACKAGE) not in cs336_systems.__path__:
    cs336_systems.__path__.append(str(_LOCAL_PACKAGE))
