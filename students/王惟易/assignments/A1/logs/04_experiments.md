...
- 日期：2026-07-16
- 状态：TinyStories tokenizer、训练基线、学习率实验、batch size 实验、四类架构消融和生成已完成；OpenWebText 尚未完成
...
当前结果已经证明主实现能够在真实语料上收敛。四类架构消融的六份对照实验也已经完成并回收；AdamW 资源核算已经补齐，剩余主线是 OpenWebText tokenizer、编码、训练、生成和跨语料 tokenizer 对比。
...
## 3. 完整 TinyStories tokenizer 与编码
