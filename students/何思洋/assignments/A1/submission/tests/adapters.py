...
def run_rope(
    ...
    return rope(in_query_or_key, theta=theta, token_positions=token_positions)
...
def run_transformer_block(
    ...
    return transformer_block(in_features, num_heads=num_heads, theta=theta, weights=weights)
...
def run_rmsnorm(
    ...
    return rmsnorm(in_features, weights, eps=eps)
...
def get_tokenizer(
    ...
    """
    from cs336_basics.tokenizer import make_tokenizer
