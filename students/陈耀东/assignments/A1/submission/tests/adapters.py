...
def run_transformer_lm(
    ...
    for layer_idx, block in enumerate(model.layers):
        ...
        block.attn.q_proj.weight.data.copy_(weights[f"{prefix}.attn.q_proj.weight"])
        block.attn.k_proj.weight.data.copy_(weights[f"{prefix}.attn.k_proj.weight"])
        block.attn.v_proj.weight.data.copy_(weights[f"{prefix}.attn.v_proj.weight"])
        block.attn.output_proj.weight.data.copy_(weights[f"{prefix}.attn.output_proj.weight"])
        block.ln1.weight.data.copy_(weights[f"{prefix}.ln1.weight"])
        block.ffn.w1.weight.data.copy_(weights[f"{prefix}.ffn.w1.weight"])
        block.ffn.w2.weight.data.copy_(weights[f"{prefix}.ffn.w2.weight"])
        block.ffn.w3.weight.data.copy_(weights[f"{prefix}.ffn.w3.weight"])
        block.ln2.weight.data.copy_(weights[f"{prefix}.ln2.weight"])
