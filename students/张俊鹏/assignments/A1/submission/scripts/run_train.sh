...
# Data
TRAIN_DATA="$ROOT/summerQuest/assignment1-basics/data/tinystories/tinystories_train.npy"
VAL_DATA="$ROOT/summerQuest/assignment1-basics/data/tinystories/tinystories_val.npy"
