...
def run_multihead_self_attention(
    ...
    MHattention = MultiHeadSelfAttention(d_model, num_heads)
    MHattention.q_proj.weight.data = q_proj_weight
    MHattention.k_proj.weight.data = k_proj_weight
    MHattention.v_proj.weight.data = v_proj_weight
    MHattention.output_proj.weight.data = o_proj_weight
    return MHattention.forward(in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    """
    from cs336_basics.model import MultiHeadSelfAttention
    MHattention = MultiHeadSelfAttention(d_model, num_heads, use_rope=True, max_seq_len=max_seq_len, theta=theta)
    MHattention.q_proj.weight.data = q_proj_weight
    MHattention.k_proj.weight.data = k_proj_weight
    MHattention.v_proj.weight.data = v_proj_weight
    MHattention.output_proj.weight.data = o_proj_weight
    return MHattention.forward(in_features, token_positions)
...
def run_transformer_block(
    ...
    return block.forward(in_features, token_positions=None)
