...
from cs336_basics.attention import MultiHeadSelfAttention, RoPE, scaled_dot_product_attention
from cs336_basics.bpe import train_bpe
from cs336_basics.checkpoint import load_checkpoint, save_checkpoint
from cs336_basics.data import get_batch
from cs336_basics.losses import cross_entropy, softmax
from cs336_basics.modules import Embedding, Linear, RMSNorm, SwiGLU, silu
...
def run_multihead_self_attention(
    ...
    with torch.no_grad():
        ...
        layer.output_proj.weight.copy_(o_proj_weight)
    return layer(in_features)
