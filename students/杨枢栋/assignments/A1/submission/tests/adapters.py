...
def run_rope(
    ...
    """
    return rope(in_query_or_key, theta, token_positions)
...
def run_transformer_block(
    ...
    """
    return transformer_block(in_features, weights, num_heads, theta)
...
def run_transformer_lm(
    ...
    """
    return transformer_lm(in_indices, weights, num_layers, num_heads, rope_theta)
