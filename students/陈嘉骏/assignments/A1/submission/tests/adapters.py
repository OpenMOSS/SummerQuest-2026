...
def run_rmsnorm(
    ...
    rms_norm = RMSNorm(d_model, eps=eps, device=weights.device, dtype=weights.dtype)
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.training import get_cosine_learning_rate

    return get_cosine_learning_rate(
        iteration=it,
