...
def run_swiglu(
    ...
    module.w1.weight.data.copy_(w1_weight)
    module.w2.weight.data.copy_(w2_weight)
    module.w3.weight.data.copy_(w3_weight)
    return module(in_features)
...
def run_multihead_self_attention(
    ...
    module.q_proj.weight.data.copy_(q_proj_weight)
    module.k_proj.weight.data.copy_(k_proj_weight)
    module.v_proj.weight.data.copy_(v_proj_weight)
...
def run_multihead_self_attention_with_rope(
    ...
    module = MultiheadSelfAttention(d_model, num_heads, rope)
    module.q_proj.weight.data.copy_(q_proj_weight)
    module.k_proj.weight.data.copy_(k_proj_weight)
    module.v_proj.weight.data.copy_(v_proj_weight)
    module.output_proj.weight.data.copy_(o_proj_weight)
...
def run_transformer_block(
    ...
    """
    module = TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta)
