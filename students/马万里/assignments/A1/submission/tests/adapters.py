...
def run_multihead_self_attention_with_rope(
    ...
    mha = MultiHeadSelfAttentionWithRoPE(d_model, num_heads, theta)
    mha.q_proj.weight.data.copy_(q_proj_weight)
    mha.k_proj.weight.data.copy_(k_proj_weight)
    mha.v_proj.weight.data.copy_(v_proj_weight)
    mha.o_proj.weight.data.copy_(o_proj_weight)
...
def run_transformer_block(
    ...
    block.attn.o_proj.weight.data.copy_(weights["attn.output_proj.weight"])
...
def run_transformer_lm(
    ...
    model.final_norm.weight.data.copy_(weights["ln_final.weight"])
    ...
    for i, layer in enumerate(model.layers):
        ...
        layer.attn.o_proj.weight.data.copy_(weights[f"{prefix}.attn.output_proj.weight"])
