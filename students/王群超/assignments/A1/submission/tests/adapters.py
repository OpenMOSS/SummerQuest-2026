...
from cs336_basics.nn_utils import (
    ...
    rmsnorm as nn_rmsnorm,
    silu as nn_silu,
    swiglu as nn_swiglu,
    softmax as nn_softmax,
    rope as nn_rope,
    scaled_dot_product_attention as nn_sdpa,
    cross_entropy as nn_cross_entropy,
    gradient_clipping as nn_gradient_clipping,
)
from cs336_basics.transformer import (
    multihead_self_attention as mha_norope,
    multihead_self_attention_with_rope as mha_rope,
    transformer_block as block_impl,
    transformer_lm as lm_impl,
)
...
def run_linear(
    ...
    return nn_linear(d_in, d_out, weights, in_features)
...
def run_embedding(
    ...
    return nn_embedding(vocab_size, d_model, weights, token_ids)
...
def run_swiglu(
    ...
    return nn_swiglu(d_model, d_ff, w1_weight, w2_weight, w3_weight, in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    """
    return mha_rope(
        d_model, num_heads, max_seq_len, theta, q_proj_weight, k_proj_weight, v_proj_weight,
...
def run_rope(
    ...
    """
    return nn_rope(d_k, theta, max_seq_len, in_query_or_key, token_positions)
...
def run_rmsnorm(
    ...
    """
    return nn_rmsnorm(d_model, eps, weights, in_features)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return nn_softmax(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    return nn_cross_entropy(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    nn_gradient_clipping(parameters, max_l2_norm)
