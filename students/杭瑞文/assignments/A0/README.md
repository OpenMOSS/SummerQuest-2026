...
|                                         |                        |               MIG M. |
|=========================================+========================+======================|
|   0  NVIDIA GeForce RTX 4090        On  |   00000000:B8:00.0 Off |                  Off |
| 30%   30C    P8             32W /  450W |      13MiB /  49140MiB |      0%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
由于使用了启智平台的 4090 计算类型组，基础镜像为：pytorch:25.06-py3:25.06 已预装 NVIDIA 驱动，故 nvidia-smi 成功。
