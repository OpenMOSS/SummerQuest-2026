...
def run_multihead_self_attention(
    ...
    attention.o_proj.weight.data.copy_(o_proj_weight)
...
def run_transformer_block(
    ...
    block.attn.o_proj.weight.data.copy_(
...
def run_transformer_lm(
    ...
    for layer_index, layer in enumerate(model.layers):
        ...
        layer.attn.o_proj.weight.data.copy_(
        ...
        layer.ffn.w1.weight.data.copy_(
            weights[f"{prefix}.ffn.w1.weight"]
        )
        layer.ffn.w2.weight.data.copy_(
            weights[f"{prefix}.ffn.w2.weight"]
        )
        layer.ffn.w3.weight.data.copy_(
            weights[f"{prefix}.ffn.w3.weight"]
        )

    model.ln_final.weight.data.copy_(
